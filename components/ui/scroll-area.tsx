...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.Scrollbar
      ...
      className={cn(
        "flex touch-none p-0.5 transition-all select-none bg-transparent hover:bg-muted/10",
    ...
    >
      <ScrollAreaPrimitive.Thumb
        ...
        className="relative flex-1 rounded-full bg-primary/40 hover:bg-primary/60 transition-colors"
      />
    </ScrollAreaPrimitive.Scrollbar>
  )
}
