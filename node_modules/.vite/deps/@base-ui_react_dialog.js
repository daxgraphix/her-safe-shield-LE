...
import "./chunk-KOL3ANN2.js";
import {
  useValueChanged
} from "./chunk-HEDMKK7I.js";
import {
  useButton
} from "./chunk-APQDW4LM.js";
import {
...
var DialogPortal = React8.forwardRef(function DialogPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
...
function useEnhancedClickHandler(handler) {
  const lastClickInteractionTypeRef = React9.useRef("");
  const handlePointerDown = React9.useCallback((event) => {
...
function useOpenInteractionType(open) {
  const [openMethod, setOpenMethod] = React10.useState(null);
...
var DialogStore = class extends ReactStore {
  constructor(initialState) {
    super(createInitialState(initialState), {
      popupRef: React12.createRef(),
      backdropRef: React12.createRef(),
      internalBackdropRef: React12.createRef(),
...
function DialogRoot(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(DialogRootContext.Provider, {
    value: contextValue,
...
var DialogViewport = React14.forwardRef(function DialogViewport2(componentProps, forwardedRef) {
  const {
    className,
    render,
    children,
...
var DialogTitle = React15.forwardRef(function DialogTitle2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var DialogTrigger = React16.forwardRef(function DialogTrigger2(componentProps, forwardedRef) {
  const {
    render,
    className,
    disabled = false,
  ...
  const triggerElementRef = React16.useRef(null);
  const {
    registerTrigger,
