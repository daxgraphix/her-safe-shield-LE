...
var SwitchRoot = React3.forwardRef(function SwitchRoot2(componentProps, forwardedRef) {
  const {
    checked: checkedProp,
    className,
    defaultChecked,
  ...
  const switchRef = React3.useRef(null);
  ...
  const inputProps = React3.useMemo(() => mergeProps(
    {
      checked,
      disabled,
      id: hiddenInputId,
...
var SwitchThumb = React4.forwardRef(function SwitchThumb2(componentProps, forwardedRef) {
  const {
    render,
    className,
    ...elementProps
