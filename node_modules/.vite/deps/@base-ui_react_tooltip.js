...
function useDirection() {
  const context = React10.useContext(DirectionContext);
...
function useAnchorPositioning(params) {
  ...
  const [mountSide, setMountSide] = React11.useState(null);
  ...
  const arrowRef = React11.useRef(null);
  ...
  const autoUpdateOptions = React11.useMemo(() => ({
  ...
  const registeredPositionReferenceRef = React11.useRef(null);
  useIsoLayoutEffect(() => {
    if (!mounted) {
      return;
    }
  ...
  const arrowStyles = React11.useMemo(() => {
    var _a2, _b2;
    return {
      position: "absolute",
...
var TooltipPositioner = React12.forwardRef(function TooltipPositioner2(componentProps, forwardedRef) {
  const {
    render,
    className,
    anchor,
...
var TooltipPopup = React13.forwardRef(function TooltipPopup2(componentProps, forwardedRef) {
  const {
    className,
    render,
    ...elementProps
...
var TooltipArrow = React14.forwardRef(function TooltipArrow2(componentProps, forwardedRef) {
  const {
    className,
    render,
    ...elementProps
...
var TooltipProvider = function TooltipProvider2(props) {
  ...
  const delayValue = React15.useMemo(() => ({
    open: delay,
    close: closeDelay
  }), [delay, closeDelay]);
...
function usePopupViewport(parameters) {
  ...
  if (!isTransitioning) {
    ...
    childrenToRender = (0, import_jsx_runtime7.jsxs)(React19.Fragment, {
...
var TooltipViewport = React20.forwardRef(function TooltipViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    children,
